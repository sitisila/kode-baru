...
if (
    ...
    try {
        ...
        $sql = "INSERT INTO users (name, username, email, password, phone, nim, role)
                VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    try {
        ...
        if (!empty($email)) {
            ...
            $contentBody = "
                ...
                <p>Silahkan masuk melalui tautan berikut:
                <a href='https://prismafitd3tektel.site'
                   style='color: #4f46e5; text-decoration: none; font-weight: bold;'>
                   https://prismafitd3tektel.site
                </a></p>
        ...
        error_log("register mail_helper error: " . $emailError);
    }
    ...
    if (!$emailSent && $emailError) {
        $response["email_warning"] = "Registrasi berhasil, namun email konfirmasi gagal terkirim.";
    }
