...
try {
    ...
    if ($asset) {
        ...
        // Kolom QTY adalah sumber kebenaran utama, sama seperti di request_loan.php
    ...
    // Update loan & asset SUDAH sukses di titik ini. Kalau email gagal,
    ...
    try {
        ...
        error_log("return_loan mail_helper error: " . $emailError);
    }
    ...
    if (!$emailSent && $emailError) {
        $response["email_warning"] = "Pengembalian berhasil, namun email konfirmasi gagal terkirim.";
    }
